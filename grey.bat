...
set BASEDIR=D:\hplegend\selfAgent
...
set AGENT_JAR=%BASEDIR%\MyPerf4J-ASM-0.0.1.jar
set BOOST_JAR=%BASEDIR%\BoostLancher-0.0.1.jar
...
%JAVACMD% -Dfile.encoding=UTF-8 %BOOT_CLASSPATH% -jar "%BOOST_JAR%" -pid "%PID%"  -boostJar "%BOOST_JAR%" -agentJar "%AGENT_JAR%" -target "%TARGET_TELNET_IP%:%TARGET_TELNET_PORT%"
